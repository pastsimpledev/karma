...
installIntro: () => "Vous souhaitez installer karma Bot sur votre appareil ?",
...
notAvailable: () => "⚠️ Cette commande est disponible uniquement avec la base de karma",
...
socialMainFooter: () => "Restez connecté avec karma",
...
socialFollowUpFooter: () => "karma - Toujours connectés",
...
broadcastHeader: () => "꒷꒦ ✦ Message de karma ✦ ꒷꒦",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Comment jouer ✦ ꒷꒦\n\nEntrez la quantité de 💶 UnityCoins à miser contre *karma-Bot*\n\n📌 Exemple :\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Choisissez une mise ci-dessous !\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Vous avez déjà misé\n  ━━✫ Attendez ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
