...
installTitle: () => "⋆ ︵ ★ 💬 karma-机器人 💬 ★ ︵ ⋆",
installIntro: () => "想在你的设备上安装karma机器人吗？",
...
notAvailable: () => "⚠️ 此命令仅适用于karma基础版",
imageNotFound: () => "⚠️ 加载图片时出错",
mainTitle: () => "🌐 我们的社交网络",
mainSubtitle: () => "随处关注我们以保持更新",
mainFooter: () => "技术支持 karma",
...
linkgroupLinkFooter: () => "技术支持 karma机器人",
...
ytSearchMissingFiles: () => "❗ 要使用此命令，请使用karma基础版",
ytSearchMissingQuery: () => "╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n 📌 输入视频名称\n 示例: .油管搜索 合集\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱",
ytSearchNoResults: () => "╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n ❌ 未找到结果\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱",
ytSearchTitle: () => "🔎 YouTube搜索",
ytSearchFooter: () => "karma ✦ 下载器",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *赌场*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ 如何游戏 ✦ ꒷꒦\n\n输入要下注的💶 UnityCoins数量对抗*karma-Bot*\n\n📌 示例:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ 在下方选择面额!\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 你已经下注过了\n  ━━✫ 等待 ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
