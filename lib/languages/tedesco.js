...
installIntro: () => "Möchtest du karma Bot auf deinem Gerät installieren?",
...
notAvailable: () => "⚠️ Dieser Befehl ist nur mit der karma-Basis verfügbar",
...
socialMainFooter: () => "Bleibe mit karma verbunden",
...
socialFollowUpFooter: () => "karma - Immer verbunden",
...
broadcastHeader: () => "꒷꒦ ✦ Nachricht von karma ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Um diesen Befehl zu verwenden, benutze die karma-Basis",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ So spielst du ✦ ꒷꒦\n\nGib die Anzahl der 💶 UnityCoins ein, die du gegen *karma-Bot* setzen möchtest\n\n📌 Beispiel:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Wähle unten einen Betrag!\n╰★────★────★╯`,
