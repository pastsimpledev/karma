...
installIntro: () => "Vuoi installare karma Bot sul tuo dispositivo?",
...
notAvailable: () => "⚠️ Questo comando è disponibile solo con la base di karma",
...
socialMainFooter: () => "Resta connesso con karma",
...
socialFollowUpFooter: () => "karma - Sempre connessi",
...
broadcastHeader: () => "꒷꒦ ✦ Messaggio da karma ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Per usare questo comando usa la base di karma",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *CASINO*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Come giocare ✦ ꒷꒦\n\nInserisci la quantità di 💶 UnityCoins da scommettere contro *karma-Bot*\n\n📌 Esempio:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Scegli un taglio qui sotto!\n╰★────★────★╯`,
betCooldown: ({ time }) => `╭﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱\n  ━━✫ 🚩 Hai già scommesso\n  ━━✫ Aspetta ⏱ ${time}\n╰﹕₊˚ ★ ⁺˳ꕤ₊⁺・꒱`,
