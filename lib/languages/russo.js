...
installTitle: () => "⋆ ︵ ★ 💬 karma-BOT 💬 ★ ︵ ⋆",
installIntro: () => "Хотите установить karma Bot на свое устройство?",
...
notAvailable: () => "⚠️ Эта команда доступна только с базой karma",
...
socialMainFooter: () => "Оставайтесь на связи с karma",
...
socialFollowUpFooter: () => "karma - Всегда на связи",
...
broadcastHeader: () => "꒷꒦ ✦ Сообщение от karma ✦ ꒷꒦",
...
ytSearchMissingFiles: () => "❗ Для использования этой команды используйте базу karma",
...
translateFooter: () => "karma Переводчик",
...
betUsage: ({ prefix, command }) => `╭┈ ─ ─ ✦ ─ ─ ┈╮\n   ୧ 🎰 ୭ *КАЗИНО*\n╰┈ ─ ─ ✦ ─ ─ ┈╯\n\n꒷꒦ ✦ Как играть ✦ ꒷꒦\n\nВведите количество 💶 UnityCoins для ставки против *karma-Bot*\n\n📌 Пример:\n${prefix}${command} 100\n\n╭★────★────★╮\n│ ୭ ˚. ᵎᵎ 🎲\n│ Выберите ставку ниже!\n╰★────★────★╯`,
